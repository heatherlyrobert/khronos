 ...
 *   khronos_list is a set of unit test accessor functions that provide the
 *   necessary data to ensure khronos is operating properly
 *
 */
/*============================================================================*/
...
unit_accessor(char *a_question, int a_num)
{
    ...
    *>    snprintf(unit_answer, LEN_TEXT, "cron counters    : %4df %5de", n_cfile, n_cline);                             <* 
    ...
    *>    snprintf(unit_answer, LEN_TEXT, "cronfile list    : %3d %10p %10p", n_cfile, h_cfile, t_cfile);             <* 
